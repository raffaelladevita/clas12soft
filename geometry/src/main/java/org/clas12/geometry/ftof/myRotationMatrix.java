...
public class myRotationMatrix {
    ...
    //--- I will fix it later.
    private myRotationMatrix setRx(double angle){
        Rx[0][0] = 1.0;
    ...
    private myRotationMatrix setRy(double angle){
    ...
    private myRotationMatrix setRz(double angle){
